...
export default function WordPuzzleScreen3({ navigation, route }) {
  const { word = "AIRPLANE", image = require("../../../assets/items/airplane.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    const extraLettersCount = Math.min(15 - word.length, 5);
    const extraLetters = 'ABCDEFGHJKMQSUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    // Navigate to puzzle4.js
    navigation.navigate('WordPuzzleScreen3');
  };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.mainContent}>
          ...
          <View style={[styles.imageContainer, { width: imageSize, height: imageSize, borderRadius: imageSize / 2 }]}>
            <Image 
              source={typeof image === 'number' ? image : require("../../../assets/items/airplane.png")} 
