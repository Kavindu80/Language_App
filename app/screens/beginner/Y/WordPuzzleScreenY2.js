...
export default function WordPuzzleScreenY2({ navigation, route }) {
  const { word = "YAK", image = require("../../../../assets/items/yak.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDEFGIJLMNOPQRSTUVWXZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenY3');
  };
