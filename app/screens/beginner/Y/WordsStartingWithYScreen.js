...
// Words starting with Y - defined outside component to prevent re-creation
const yWords = [
  {
    word: "Yacht",
    image: require("../../../../assets/items/yacht.png")
  },
  {
    word: "Yak",
    image: require("../../../../assets/items/yak.png")
  },
  {
    word: "Yarn",
    image: require("../../../../assets/items/yarn.png")
  },
  {
    word: "Yogurt",
    image: require("../../../../assets/items/yogurt.png")
  },
  {
    word: "Yoyo",
    image: require("../../../../assets/items/yoyo.png")
  }
];

export default function WordsStartingWithYScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenY1', {
            word: yWords[0].word.toUpperCase(),
            image: yWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
