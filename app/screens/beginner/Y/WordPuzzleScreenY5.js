...
export default function WordPuzzleScreenY5({ navigation, route }) {
  const { word = "YOYO", image = require("../../../../assets/items/yoyo.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEFGIJKLMNPQRSTUVWXZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenY');
  };
