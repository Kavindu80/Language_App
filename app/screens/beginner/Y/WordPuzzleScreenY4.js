...
export default function WordPuzzleScreenY4({ navigation, route }) {
  const { word = "YOGURT", image = require("../../../../assets/items/yogurt.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDEFGIJKLMOPQSTUVWXZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenY5');
  };
