...
export default function VerbsScreenY() {
  ...
  const verbs = [
    { 
      id: 1, 
      word: 'Yawn', 
      meaning: 'To open your mouth wide when tired.',
    ...
    { 
      id: 3, 
      word: 'Yield', 
      meaning: 'To give way or allow something to happen.',
      example: 'The car yielded to the pedestrian.'
    },
    { 
      id: 4, 
      word: 'Yank', 
      meaning: 'To pull something hard and suddenly.',
      example: 'He yanked the door open.'
    },
    { 
      id: 5, 
      word: 'Yodel', 
      meaning: 'To sing with quick changes of pitch.',
      example: 'The singer yodeled in the performance.'
    },
    { 
      id: 6, 
      word: 'Yearn', 
      meaning: 'To want something very badly.',
      example: 'She yearned to travel the world.'
    },
    { 
      id: 7, 
      word: 'Yank off', 
      meaning: 'To pull off suddenly.',
      example: 'He yanked off the sticker.'
    },
    { 
      id: 8, 
      word: 'Yammer', 
      meaning: 'To talk a lot in an annoying way.',
      example: 'He yammered on about his problems.'
    },
    { 
      id: 9, 
      word: 'Yoke', 
      meaning: 'To join together (often animals or tools).',
      example: 'The oxen were yoked to the cart.'
    },
    { 
      id: 10, 
      word: 'Yawn (figurative)', 
      meaning: 'To open widely (e.g. gap or hole).',
      example: 'A wide hole yawned before them.'
    }
  ];
