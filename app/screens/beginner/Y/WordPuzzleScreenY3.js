...
export default function WordPuzzleScreenY3({ navigation, route }) {
  const { word = "YARN", image = require("../../../../assets/items/yarn.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenY4');
  };
