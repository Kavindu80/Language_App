...
export default function WordPuzzleScreenU2({ navigation, route }) {
  const { word = "UNICORN", image = require("../../../../assets/items/unicorn.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenU3');
  };
