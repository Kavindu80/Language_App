...
// Words starting with U - defined outside component to prevent re-creation
const uWords = [
  {
    word: "Umbrella",
    image: require("../../../../assets/items/umbrella.png")
  },
  {
    word: "Unicorn",
    image: require("../../../../assets/items/unicorn.png")
  },
  {
    word: "Uniform",
    image: require("../../../../assets/items/uniform.png")
  },
  {
    word: "Universe",
    image: require("../../../../assets/items/universe.png")
  },
  {
    word: "Ukulele",
    image: require("../../../../assets/items/ukulele.png")
  }
];

export default function WordsStartingWithUScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenU1', {
            word: uWords[0].word.toUpperCase(),
            image: uWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
