...
export default function WordPuzzleScreenU3({ navigation, route }) {
  const { word = "UNIFORM", image = require("../../../../assets/items/uniform.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenU4');
  };
