...
export default function WordPuzzleScreenU4({ navigation, route }) {
  const { word = "UNIVERSE", image = require("../../../../assets/items/universe.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenU5');
  };
