...
export default function WordPuzzleScreenU1({ navigation, route }) {
  const { word = "UMBRELLA", image = require("../../../../assets/items/umbrella.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenU2');
  };
