...
export default function WordPuzzleScreenP2({ navigation, route }) {
  const { word = "PENGUIN", image = require("../../../../assets/items/penguin.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABDFHJKLMOPQRSVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenP3');
  };
