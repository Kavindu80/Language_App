...
export default function WordPuzzleScreenP3({ navigation, route }) {
  const { word = "PUMPKIN", image = require("../../../../assets/items/pumpkin.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABDEFGHJLOQRSVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenP4');
  };
