...
export default function WordPuzzleScreenP5({ navigation, route }) {
  const { word = "PANDA", image = require("../../../../assets/items/panda2.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCEFGHIJKLMOQRSTVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenP');
  };
