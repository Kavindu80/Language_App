...
export default function WordPuzzleScreenP1({ navigation, route }) {
  const { word = "PENCIL", image = require("../../../../assets/items/pencil.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABDFGHJKMOPQRSUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenP2');
  };
