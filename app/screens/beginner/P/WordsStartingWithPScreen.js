...
// Words starting with P - defined outside component to prevent re-creation
const pWords = [
  {
    word: "Pencil",
    image: require("../../../../assets/items/pencil.png")
  },
  {
    word: "Penguin",
    image: require("../../../../assets/items/penguin.png")
  },
  {
    word: "Pumpkin",
  ...
  {
    word: "Parrot",
    image: require("../../../../assets/items/parrot.png")
  },
  {
    word: "Panda",
    image: require("../../../../assets/items/panda2.png")
  }
];

export default function WordsStartingWithPScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenP1', {
            word: pWords[0].word.toUpperCase(),
            image: pWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
