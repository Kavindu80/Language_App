...
export default function VerbsScreenP() {
  ...
  const verbs = [
    { 
      id: 1, 
      word: 'Pack', 
      meaning: 'To put things into a bag or box.',
      example: 'He packed his suitcase.'
    },
    { 
      id: 2, 
      word: 'Paint', 
      meaning: 'To cover the surface with color.',
    ...
    { 
      id: 4, 
      word: 'Play', 
      meaning: 'To do something for fun or sport.',
    ...
    { 
      ...
      example: 'Please push the gate to open it.'
    },
    { 
      id: 7, 
      word: 'Print', 
      meaning: 'To produce words or images on paper.',
      example: 'He printed the report.'
    },
    { 
      id: 8, 
      word: 'Prove', 
      meaning: 'To show something is true.',
      example: 'He proved he was right.'
    },
    { 
      id: 9, 
      word: 'Protect', 
    ...
    { 
      id: 10, 
      word: 'Provide', 
      meaning: 'To give what is needed.',
      example: 'The school provides lunch for students.'
    }
  ];
