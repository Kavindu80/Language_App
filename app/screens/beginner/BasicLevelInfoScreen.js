  ...
  const sections = [
    {
      ...
      description: 'All 26 letters (A-Z) with pronunciation and common words for each letter.',
      icon: 'font',
    },
    {
      id: 2,
      title: 'Basic Vocabulary',
      description: 'Common words, objects, animals, colors, numbers and food items.',
      icon: 'book',
    },
    {
      id: 3,
      title: 'Simple Sentences',
      description: 'How to form basic sentences and questions for everyday communication.',
      icon: 'comment-alt',
    },
    {
      id: 4,
    ...
    >
      ...
      <ScrollView style={styles.contentContainer} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.descriptionText}>
          This is perfect for beginners who are just starting to learn English. You'll build a strong foundation with these core topics:
        </Text>
        ...
        <View style={styles.goalContainer}>
          ...
          <Text style={styles.goalText}>
            By completing this level, you'll be able to recognize all English letters, sounds, words and communicate simple needs in English.
          </Text>
        </View>
      </ScrollView>
