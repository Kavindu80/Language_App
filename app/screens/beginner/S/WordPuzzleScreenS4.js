...
export default function WordPuzzleScreenS4({ navigation, route }) {
  const { word = "STRAWBERRY", image = require("../../../../assets/items/strawberry.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    const extraLettersCount = Math.min(12 - word.length, 3);
    const extraLetters = 'BCDFGHJKLMOPQUVXZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenS5');
  };
