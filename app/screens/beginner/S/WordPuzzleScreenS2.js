...
export default function WordPuzzleScreenS2({ navigation, route }) {
  const { word = "STAR", image = require("../../../../assets/items/star.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDEFGHIJKLMOPQUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenS3');
  };
