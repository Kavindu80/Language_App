...
// Words starting with S - defined outside component to prevent re-creation
const sWords = [
  {
    word: "Sun",
    image: require("../../../../assets/items/sun.png")
  },
  {
    word: "Star",
  ...
  {
    word: "Snake",
    image: require("../../../../assets/items/snake.png")
  },
  {
    word: "Strawberry",
    image: require("../../../../assets/items/strawberry.png")
  },
  {
    word: "Sheep",
    image: require("../../../../assets/items/sheep.png")
  }
];

export default function WordsStartingWithSScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenS1', {
            word: sWords[0].word.toUpperCase(),
            image: sWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
