...
export default function WordPuzzleScreenS3({ navigation, route }) {
  const { word = "SNAKE", image = require("../../../../assets/items/snake.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDFGHIJLMOPQRTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenS4');
  };
