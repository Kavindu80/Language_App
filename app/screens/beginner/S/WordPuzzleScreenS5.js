...
export default function WordPuzzleScreenS5({ navigation, route }) {
  const { word = "SHEEP", image = require("../../../../assets/items/sheep.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGIJKLMNOPQRTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    // Navigate to the alphabet screen or another appropriate screen
    navigation.navigate('VerbsScreenS');
  };
