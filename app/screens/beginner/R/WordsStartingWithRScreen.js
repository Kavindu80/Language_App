...
// Words starting with R - defined outside component to prevent re-creation
const rWords = [
  {
    word: "Rabbit",
    image: require("../../../../assets/items/rabbit.png")
  },
  {
    word: "Rainbow",
    image: require("../../../../assets/items/rainbow.png")
  },
  {
    word: "Rocket",
    image: require("../../../../assets/items/rocket.png")
  },
  {
    word: "Robot",
    image: require("../../../../assets/items/robot.png")
  },
  {
    word: "Rose",
    image: require("../../../../assets/items/rose.png")
  }
];

export default function WordsStartingWithRScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenR1', {
            word: rWords[0].word.toUpperCase(),
            image: rWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
