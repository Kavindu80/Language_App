...
export default function WordPuzzleScreenR4({ navigation, route }) {
  const { word = "ROBOT", image = require("../../../../assets/items/robot.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ACDEFGHJKLMNPQSUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenR5');
  };
