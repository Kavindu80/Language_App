...
export default function WordPuzzleScreenR2({ navigation, route }) {
  const { word = "RAINBOW", image = require("../../../../assets/items/rainbow.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'CDEFGHJKLMPQSUVXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenR3');
  };
