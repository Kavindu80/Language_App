...
export default function WordPuzzleScreenR3({ navigation, route }) {
  const { word = "ROCKET", image = require("../../../../assets/items/rocket.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABDFGHJLMPQSUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenR4');
  };
