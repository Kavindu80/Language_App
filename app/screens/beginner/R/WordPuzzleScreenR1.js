...
export default function WordPuzzleScreenR1({ navigation, route }) {
  const { word = "RABBIT", image = require("../../../../assets/items/rabbit.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'CDEFGHIJKLMNOPQSUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenR2');
  };
