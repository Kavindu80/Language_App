...
export default function WordPuzzleScreenX3({ navigation, route }) {
  const { word = "XERUS", image = require("../../../../assets/items/xerus.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHJKLMPQRSTUVWZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenX4');
  };
