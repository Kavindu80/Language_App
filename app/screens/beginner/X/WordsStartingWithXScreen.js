...
// Words starting with X - defined outside component to prevent re-creation
const xWords = [
  {
    word: "Xylophone",
    image: require("../../../../assets/items/xylophone.png")
  },
  {
    word: "X-ray",
    image: require("../../../../assets/items/xray.png")
  },
  {
    word: "Xerus",
    image: require("../../../../assets/items/xerus.png")
  },
  {
    word: "Xerox",
    image: require("../../../../assets/items/xerox.png")
  },
  {
    word: "Xmas",
    image: require("../../../../assets/items/xbox.png")
  }
];

export default function WordsStartingWithXScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenX1', {
            word: xWords[0].word.toUpperCase(),
            image: xWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
