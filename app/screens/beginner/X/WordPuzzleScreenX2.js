...
export default function WordPuzzleScreenX2({ navigation, route }) {
  const { word = "XRAY", image = require("../../../../assets/items/xray.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCEFGHJKLMPQSTUVWZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenX3');
  };
