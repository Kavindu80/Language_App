...
export default function VerbsScreenX() {
  ...
  const verbs = [
    { 
      id: 1, 
      word: 'X-ray', 
      meaning: 'To take a photo of the inside of the body.',
      example: 'The doctor X-rayed his chest.'
    },
    { 
      id: 2, 
      word: 'X-out', 
      meaning: 'To cross something out with an X.',
      example: 'He X-ed out the wrong answer.'
    },
    { 
      id: 3, 
      word: 'Xerox', 
      meaning: 'To make a photocopy of something.',
      example: 'She xeroxed the important documents.'
    },
    { 
      id: 4, 
      word: 'Xeriscape', 
      meaning: 'To landscape using plants that need little water.',
      example: 'They xeriscaped their yard to save water.'
    }
  ];
  ...
  return (
    ...
    >
      ...
      <Text style={styles.noteText}>
        Note: Verbs starting with X are rare and often borrowed or technical.
      </Text>
      ...
      >
        ...
        >
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate("XPuzzleProgressScreen")}
