...
export default function WordPuzzleScreenX5({ navigation, route }) {
  const { word = "XBOX", image = require("../../../../assets/items/xbox.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ACDEFGHJKLMNPQRSTUVWZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenX');
  };
