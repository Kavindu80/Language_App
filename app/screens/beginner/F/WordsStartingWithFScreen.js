...
// Words starting with F - defined outside component to prevent re-creation
const fWords = [
  {
    word: "Fish",
    image: require("../../../../assets/items/fish.png")
  },
  {
    word: "Flower",
    image: require("../../../../assets/items/flower.png")
  },
  {
    word: "Frog",
    image: require("../../../../assets/items/frog.png")
  },
  {
    word: "Fox",
    image: require("../../../../assets/items/fox.png")
  },
  {
    word: "Flag",
    image: require("../../../../assets/items/flag.png")
  }
];

export default function WordsStartingWithFScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenF1', {
            word: fWords[0].word.toUpperCase(),
            image: fWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
