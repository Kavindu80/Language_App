...
export default function WordPuzzleScreenF2({ navigation, route }) {
  const { word = "FLOWER", image = require("../../../../assets/items/flower.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDGIJKMNPQSTUVXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate('WordPuzzleScreenF3');
  };
