...
export default function WordPuzzleScreenF4({ navigation, route }) {
  const { word = "FOX", image = require("../../../../assets/items/fox.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEGHIJKLMNPQRSTUVWYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate('WordPuzzleScreenF5');
  };
