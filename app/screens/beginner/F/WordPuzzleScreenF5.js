...
export default function WordPuzzleScreenF5({ navigation, route }) {
  const { word = "FLAG", image = require("../../../../assets/items/flag.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDEHJKMNOPQRSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenF');
  };
