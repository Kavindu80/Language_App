...
export default function WordPuzzleScreenF3({ navigation, route }) {
  const { word = "FROG", image = require("../../../../assets/items/frog.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEIJKLMNPQSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate("WordPuzzleScreenF4");
  };
