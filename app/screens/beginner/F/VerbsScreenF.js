...
export default function VerbsScreenF() {
  ...
  const verbs = [
    { 
      id: 1, 
      word: 'Fail', 
      meaning: 'To not succeed in what you are trying to do.',
      example: 'He failed the exam last week.'
    },
    { 
      id: 2, 
      word: 'Fall', 
      meaning: 'To drop down from a higher place to a lower place.',
    ...
    { 
      ...
      example: 'She feeds her dog every morning.'
    },
    { 
      id: 4, 
      word: 'Feel', 
    ...
    { 
      id: 5, 
      word: 'Fight', 
      meaning: 'To try to defeat someone by using physical force or words.',
      example: 'The brothers sometimes fight over toys.'
    },
    { 
      id: 6, 
      word: 'Find', 
      meaning: 'To discover something or someone that you are looking for.',
    ...
    { 
      ...
      example: 'They finished their homework before dinner.'
    },
    { 
      id: 8, 
      word: 'Fly', 
    ...
    { 
      id: 9, 
      word: 'Follow', 
      meaning: 'To go after someone or something.',
      example: 'Please follow me to the classroom.'
    },
    { 
      id: 10, 
      word: 'Forget', 
      meaning: 'To not remember something.',
      example: 'I forgot my umbrella at home.'
    },
  ];
