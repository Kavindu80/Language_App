...
export default function VerbsScreenN() {
  ...
  const verbs = [
    { 
      id: 1, 
      word: 'Name', 
      meaning: 'To give a name to something.',
      example: 'They named the baby Emma.'
    },
    { 
      id: 2, 
      word: 'Need', 
    ...
    { 
      id: 4, 
      word: 'Nod', 
      meaning: 'To move your head up and down to say yes.',
    ...
    { 
      ...
      example: 'The teacher narrated a fairy tale.'
    },
    { 
      id: 6, 
      word: 'Neglect', 
      meaning: 'To fail to care for something.',
      example: 'He neglected his duties.'
    },
    { 
      id: 7, 
      word: 'Nail', 
      meaning: 'To fix something using nails.',
    ...
    { 
      ...
      example: 'She navigated through the forest.'
    },
    { 
      id: 9, 
      word: 'Notice', 
      meaning: 'To see or observe carefully.',
      example: 'I noticed a small crack.'
    },
    { 
      id: 10, 
      word: 'Nurture', 
      meaning: 'To help grow or develop.',
