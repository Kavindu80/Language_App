...
// Words starting with N - defined outside component to prevent re-creation
const nWords = [
  {
    word: "Nest",
    image: require("../../../../assets/items/nest.png")
  },
  {
    word: "Nose",
    image: require("../../../../assets/items/nose.png")
  },
  {
    word: "Nail",
    image: require("../../../../assets/items/nail.png")
  },
  {
    word: "Net",
    image: require("../../../../assets/items/net.png")
  },
  {
    word: "Nurse",
    image: require("../../../../assets/items/nurse.png")
  }
];

export default function WordsStartingWithNScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenN1', {
            word: nWords[0].word.toUpperCase(),
            image: nWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
