...
export default function WordPuzzleScreenN5({ navigation, route }) {
  const { word = "NURSE", image = require("../../../../assets/items/nurse.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHIKLMOPQTWVXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenN');
  };
