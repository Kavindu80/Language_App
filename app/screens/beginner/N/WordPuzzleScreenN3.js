...
export default function WordPuzzleScreenN3({ navigation, route }) {
  const { word = "NAIL", image = require("../../../../assets/items/nail.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEFGHJKMOPQRSTUVWXZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenN4');
  };
