...
export default function WordPuzzleScreenN1({ navigation, route }) {
  const { word = "NEST", image = require("../../../../assets/items/nest.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHIKLMOPQRUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenN2');
  };
