...
export default function WordPuzzleScreenG3({ navigation, route }) {
  const { word = "GRAPES", image = require("../../../../assets/items/grapes.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDFHIJKLMNOQTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate("WordPuzzleScreenG4");
  };
