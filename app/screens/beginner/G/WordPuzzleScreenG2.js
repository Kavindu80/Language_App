...
export default function WordPuzzleScreenG2({ navigation, route }) {
  const { word = "GIRAFFE", image = require("../../../../assets/items/giraffe.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDHJKLMNOPQSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate('WordPuzzleScreenG3');
  };
