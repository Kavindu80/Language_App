...
export default function WordPuzzleScreenG5({ navigation, route }) {
  const { word = "GIFT", image = require("../../../../assets/items/gift.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEHJKLMNOPQRSUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenG');
  };
