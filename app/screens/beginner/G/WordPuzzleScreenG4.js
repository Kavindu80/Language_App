...
export default function WordPuzzleScreenG4({ navigation, route }) {
  const { word = "GUITAR", image = require("../../../../assets/items/guitar.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEFHJKLMNOPQSVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate('WordPuzzleScreenG5');
  };
