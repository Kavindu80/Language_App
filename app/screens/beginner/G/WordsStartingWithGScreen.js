...
// Words starting with G - defined outside component to prevent re-creation
const gWords = [
  {
    word: "Goat",
    image: require("../../../../assets/items/goat.png")
  },
  {
    word: "Giraffe",
    image: require("../../../../assets/items/giraffe.png")
  },
  {
    word: "Grapes",
    image: require("../../../../assets/items/grapes.png")
  },
  {
    word: "Guitar",
    image: require("../../../../assets/items/guitar.png")
  },
  {
    word: "Gift",
    image: require("../../../../assets/items/gift.png")
  }
];

export default function WordsStartingWithGScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenG1', {
            word: gWords[0].word.toUpperCase(),
            image: gWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
