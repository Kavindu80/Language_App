...
export default function NumbersScreen() {
  ...
  const practiceQuestions = [
    { 
      id: 1, 
      question: "How many fingers are up?", 
      options: ["One", "Two", "Three"], 
      answer: "Two", 
      image: require('../../../../assets/items/2fingers.png'),
      description: "Count how many fingers you see."
    },
    { 
      id: 2, 
      ...
      options: ["2", "5", "8"], 
      answer: "5", 
      image: require('../../../../assets/items/five.png'),
    ...
    { 
      ...
      options: ["3", "6", "9"], 
      answer: "3", 
      image: require('../../../../assets/items/3star.png'),
      ...
      {!showPractice ? (
        ...
        >
          ...
          <View style={styles.navigationControls}>
            ...
            >
              <Ionicons name="chevron-back" size={24} color={activeIndex === 0 ? "#bbb" : "#0072ff"} />
            </TouchableOpacity>
            ...
            >
              <Ionicons name="chevron-forward" size={24} color={activeIndex === numbers.length - 1 ? "#bbb" : "#0072ff"} />
            </TouchableOpacity>
          </View>
            ...
            <View style={styles.resultContainer}>
              ...
              >
                ...
                <Text style={styles.resultTitle}>
                  {practiceScore === practiceQuestions.length ? 'Awesome! You got 3 out of 3. Perfect!' : 
                   practiceScore === 2 ? 'Well done! You answered 2 out of 3 questions correctly.' : 
                   practiceScore === 1 ? 'Good try! You got 1 out of 3. Keep practicing!' :
                   'Oops! No correct answers this time but keep going!'}
                </Text>
                ...
                <View style={styles.resultButtonsContainer}>
                  ...
                  >
                    <View style={styles.tryAgainGradient}>
                      <FontAwesome5 name="redo" size={16} color="#0072ff" style={{marginRight: 8}} />
                  ...
                  >
                    <View style={styles.continueGradient}>
                      ...
                      <FontAwesome5 name="arrow-right" size={16} color="#0072ff" style={{marginLeft: 8}} />
                    </View>
                  </TouchableOpacity>
                </View>
              </LinearGradient>
