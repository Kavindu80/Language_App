...
export default function WordPuzzleScreenD3({ navigation, route }) {
  const { word = "DOOR", image = require("../../../../assets/items/door.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenD4');
  };
