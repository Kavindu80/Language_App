...
export default function WordPuzzleScreenD1({ navigation, route }) {
  const { word = "DOG", image = require("../../../../assets/items/dog.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenD2');
  };
