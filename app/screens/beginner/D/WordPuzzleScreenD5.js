...
export default function WordPuzzleScreenD5({ navigation, route }) {
  const { word = "DESK", image = require("../../../../assets/items/desk.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenD');
  };
