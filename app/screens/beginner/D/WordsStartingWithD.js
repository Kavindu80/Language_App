...
// Words starting with D - defined outside component to prevent re-creation
const dWords = [
  {
    word: "Dog",
  ...
  {
    word: "Duck",
    image: require("../../../../assets/items/duck.png")
  },
  {
    word: "Door",
    image: require("../../../../assets/items/door.png")
  },
  {
    word: "Desk",
    image: require("../../../../assets/items/desk.png")
  },
  {
    word: "Doll",
    image: require("../../../../assets/items/doll.png")
  }
];

export default function WordsStartingWithDScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenD1', {
            word: dWords[0].word.toUpperCase(),
            image: dWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
