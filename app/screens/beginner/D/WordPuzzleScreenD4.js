...
export default function WordPuzzleScreenD4({ navigation, route }) {
  const { word = "DOLL", image = require("../../../../assets/items/doll.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenD5');
  };
