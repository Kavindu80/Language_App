...
export default function WordPuzzleScreenZ4({ navigation, route }) {
  const { word = "ZERO", image = require("../../../../assets/items/zero.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHIJKLMNPQSTUVWXY'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenZ5');
  };
