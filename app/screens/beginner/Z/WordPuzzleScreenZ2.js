...
export default function WordPuzzleScreenZ2({ navigation, route }) {
  const { word = "ZOO", image = require("../../../../assets/items/zoo.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEFGHIJKLMNPQRSTUVWXY'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenZ3');
  };
