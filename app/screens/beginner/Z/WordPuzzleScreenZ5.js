...
export default function WordPuzzleScreenZ5({ navigation, route }) {
  const { word = "ZINC", image = require("../../../../assets/items/zinc.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEFGHJKLMNOPQRSTUVWXY'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenZ');
  };
