...
// Words starting with Z - defined outside component to prevent re-creation
const zWords = [
  {
    word: "Zebra",
    image: require("../../../../assets/items/zebra.png")
  },
  {
    word: "Zoo",
    image: require("../../../../assets/items/zoo.png")
  },
  {
    word: "Zipper",
    image: require("../../../../assets/items/zipper.png")
  },
  {
    word: "Zero",
    image: require("../../../../assets/items/zero.png")
  },
  {
    word: "Zinc",
    image: require("../../../../assets/items/zinc.png")
  }
];

export default function WordsStartingWithZScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenZ1', {
            word: zWords[0].word.toUpperCase(),
            image: zWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
