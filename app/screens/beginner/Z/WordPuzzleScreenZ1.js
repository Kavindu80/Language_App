...
export default function WordPuzzleScreenZ1({ navigation, route }) {
  const { word = "ZEBRA", image = require("../../../../assets/items/zebra.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHIJKLMNOPQSTUVWXY'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenZ2');
  };
