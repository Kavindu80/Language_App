...
export default function WordPuzzleScreenL3({ navigation, route }) {
  const { word = "LEAF", image = require("../../../../assets/items/leaf.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDHIJKMNOPQRSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenL4');
  };
