...
// Words starting with L - defined outside component to prevent re-creation
const lWords = [
  {
    word: "Lion",
    image: require("../../../../assets/items/lion.png")
  },
  {
    word: "Lamp",
    image: require("../../../../assets/items/lamp.png")
  },
  {
    word: "Leaf",
  ...
  {
    word: "Lock",
    image: require("../../../../assets/items/lock.png")
  }
];

export default function WordsStartingWithLScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenL1', {
            word: lWords[0].word.toUpperCase(),
            image: lWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
