...
export default function VerbsScreenL() {
  ...
  const verbs = [
    { 
      id: 1, 
      word: 'Laugh', 
      meaning: 'To make sounds of joy or amusement.',
    ...
    { 
      id: 3, 
      word: 'Leave', 
      meaning: 'To get away from a place.',
      example: 'He left the office early.'
    },
    { 
      id: 4, 
      word: 'Like', 
      meaning: 'To enjoy or feel good about something.',
    ...
    { 
      id: 6, 
      word: 'Look', 
      meaning: 'To direct your eyes at something.',
      example: 'Look at the sky!'
    },
    { 
      id: 7, 
      word: 'Love', 
      meaning: 'To care for someone deeply.',
      example: 'I love my family.'
    },
    { 
      id: 8, 
      word: 'Live', 
      meaning: 'To be alive or to reside somewhere.',
      example: 'They live in Colombo.'
    },
    { 
      id: 9, 
      word: 'Lift', 
      meaning: 'To raise something up.',
      example: 'He lifted the box with ease.'
    },
    { 
      id: 10, 
      word: 'Lose', 
