...
export default function WordPuzzleScreenL2({ navigation, route }) {
  const { word = "LAMP", image = require("../../../../assets/items/lamp.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDEFGHIJKNOQRSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenL3');
  };
