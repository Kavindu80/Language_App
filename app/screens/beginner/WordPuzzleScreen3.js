...
export default function WordPuzzleScreen3({ navigation, route }) {
  const { word = "ARROW", image = require("../../../assets/items/arrow.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreen4');
  };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.mainContent}>
          ...
          <View style={[styles.imageContainer, { width: imageSize, height: imageSize, borderRadius: imageSize / 2 }]}>
            <Image 
              source={typeof image === 'number' ? image : require("../../../assets/items/arrow.png")} 
