...
export default function WordPuzzleScreenH3({ navigation, route }) {
  const { word = "HORSE", image = require("../../../../assets/items/horse.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGIJKLMNPQTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate("WordPuzzleScreenH4");
  };
