...
// Words starting with H - defined outside component to prevent re-creation
const hWords = [
  {
    word: "Hat",
    image: require("../../../../assets/items/hat.png")
  },
  {
    word: "House",
    image: require("../../../../assets/items/house.png")
  },
  {
    word: "Horse",
    image: require("../../../../assets/items/horse.png")
  },
  {
    word: "Hand",
  ...
  {
    word: "Heart",
    image: require("../../../../assets/items/heart.png")
  }
];

export default function WordsStartingWithHScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenH1', {
            word: hWords[0].word.toUpperCase(),
            image: hWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
