...
export default function WordPuzzleScreenH4({ navigation, route }) {
  const { word = "HAND", image = require("../../../../assets/items/hand.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCEFGIJKLMOPQRSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate("WordPuzzleScreenH5");
  };
