...
export default function WordPuzzleScreenH2({ navigation, route }) {
  const { word = "HOUSE", image = require("../../../../assets/items/house.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGIJKLMNPQRTVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate('WordPuzzleScreenH3');
  };
