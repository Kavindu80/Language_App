...
export default function WordPuzzleScreenH5({ navigation, route }) {
  const { word = "HEART", image = require("../../../../assets/items/heart.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate("VerbsScreenH");
  };
