...
export default function WordPuzzleScreenW4({ navigation, route }) {
  const { word = "WHALE", image = require("../../../../assets/items/whale.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDFGIJKMNOPQRSTUVXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenW5');
  };
