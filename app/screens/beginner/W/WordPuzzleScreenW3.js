...
export default function WordPuzzleScreenW3({ navigation, route }) {
  const { word = "WATCH", image = require("../../../../assets/items/watch.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABDEFGIJKLMNOPQRSUVXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenW4');
  };
