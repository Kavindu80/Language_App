...
export default function WordPuzzleScreenW1({ navigation, route }) {
  const { word = "WATER", image = require("../../../../assets/items/water.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEFGHIJKLMNOPQRSTVUXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenW2');
  };
