...
export default function WordPuzzleScreenW5({ navigation, route }) {
  const { word = "WAGON", image = require("../../../../assets/items/wagon.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDEFHIJKLMPQRSTUVXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenW');
  };
