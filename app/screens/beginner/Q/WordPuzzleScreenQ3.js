...
export default function WordPuzzleScreenQ3({ navigation, route }) {
  const { word = "QUAIL", image = require("../../../../assets/items/quail.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDEFGHJKMNOPRSTUVWXZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenQ4');
  };
