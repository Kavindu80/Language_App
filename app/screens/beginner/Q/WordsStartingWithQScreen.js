...
// Words starting with Q - defined outside component to prevent re-creation
const qWords = [
  {
    word: "Queen",
    image: require("../../../../assets/items/queen.png")
  },
  {
    word: "Quilt",
    image: require("../../../../assets/items/quilt.png")
  },
  {
    word: "quail",
    image: require("../../../../assets/items/quail.png")
  },
  {
    word: "Question",
    image: require("../../../../assets/items/quince.png")
  },
  {
    word: "Quiet",
    image: require("../../../../assets/items/quiet.png")
  }
];

export default function WordsStartingWithQScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenQ1', {
            word: qWords[0].word.toUpperCase(),
            image: qWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
