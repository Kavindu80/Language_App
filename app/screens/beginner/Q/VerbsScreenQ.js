...
export default function VerbsScreenQ() {
  ...
  const verbs = [
    { 
      id: 1, 
      word: 'Qualify', 
      meaning: 'To meet the standard or skill required.',
      example: 'She qualified for the finals.'
    },
    { 
      id: 2, 
      word: 'Question', 
      meaning: 'To ask about something.',
      example: 'The reporter questioned the player.'
    },
    { 
      id: 3, 
      word: 'Quote', 
      meaning: 'To repeat someone\'s words.',
      example: 'He quoted a famous poet.'
    },
    { 
      id: 4, 
      word: 'Queue', 
      meaning: 'To line up and wait.',
      example: 'We queued for tickets.'
    },
    { 
      id: 5, 
      word: 'Quarrel', 
    ...
    { 
      id: 8, 
      word: 'Question (someone)', 
      meaning: 'To ask them to get answers.',
    ...
    { 
      ...
      example: 'She quivered with cold.'
    },
    { 
      id: 10, 
      word: 'Quote (price)', 
      meaning: 'To state a price for something.',
      example: 'The mechanic quoted $50 for the repair.'
    }
  ];
