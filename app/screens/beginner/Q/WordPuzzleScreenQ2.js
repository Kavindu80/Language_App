...
export default function WordPuzzleScreenQ2({ navigation, route }) {
  const { word = "QUILT", image = require("../../../../assets/items/quilt.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHKMNOPRSVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenQ3');
  };
