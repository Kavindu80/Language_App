...
export default function WordPuzzleScreen4({ navigation, route }) {
  const { word = "AMBULANCE", image = require("../../../assets/items/ambulance.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    // Navigate to puzzle2.js instead of going back
    navigation.navigate('WordPuzzleScreen5');
  };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.mainContent}>
          ...
          <View style={[styles.imageContainer, { width: imageSize, height: imageSize, borderRadius: imageSize / 2 }]}>
            <Image 
              source={typeof image === 'number' ? image : require("../../../assets/items/ambulance.png")} 
