...
export default function WordPuzzleScreenM1({ navigation, route }) {
  const { word = "MONKEY", image = require("../../../../assets/items/monkey.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHIJLPQRSTUVWXZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenM2');
  };
