...
export default function WordPuzzleScreenM4({ navigation, route }) {
  const { word = "MANGO", image = require("../../../../assets/items/mango.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDEFHIJKLPQRSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenM5');
  };
