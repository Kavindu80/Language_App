...
export default function WordPuzzleScreenM3({ navigation, route }) {
  const { word = "MOUSE", image = require("../../../../assets/items/mouse.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHIJKLNPQRTVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenM4');
  };
