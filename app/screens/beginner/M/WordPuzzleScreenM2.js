...
export default function WordPuzzleScreenM2({ navigation, route }) {
  const { word = "MOON", image = require("../../../../assets/items/moon.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEFGHIJKLPQRSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenM3');
  };
