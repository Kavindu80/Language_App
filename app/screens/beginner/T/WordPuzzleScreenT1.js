...
export default function WordPuzzleScreenT1({ navigation, route }) {
  const { word = "TABLE", image = require("../../../../assets/items/table.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEFGHIJKLMNOPQRSVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenT2');
  };
