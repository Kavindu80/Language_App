...
export default function WordPuzzleScreenT4({ navigation, route }) {
  const { word = "TRAIN", image = require("../../../../assets/items/train.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDFGHJKLMOPQSUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenT5');
  };
