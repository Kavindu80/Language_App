...
export default function WordPuzzleScreenT5({ navigation, route }) {
  const { word = "TURTLE", image = require("../../../../assets/items/turtle.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHJKMNOPQSVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenT');
  };
