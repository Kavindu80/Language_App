...
export default function WordPuzzleScreenT2({ navigation, route }) {
  const { word = "TIGER", image = require("../../../../assets/items/tiger.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFHJKLMNOPQSUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenT3');
  };
