...
export default function VerbsScreenT() {
  ...
  const verbs = [
    { 
      id: 1, 
      word: 'Take', 
      meaning: 'To get or hold something with your hand.',
      example: 'Please take your books.'
    },
    { 
      id: 2, 
      word: 'Talk', 
      meaning: 'To speak in order to share ideas or feelings.',
    ...
    { 
      id: 4, 
      word: 'Tell', 
      meaning: 'To give information or say something.',
      example: 'Can you tell me your name?'
    },
    { 
      id: 5, 
      word: 'Think', 
      meaning: 'To use your mind to form ideas or opinions.',
      example: 'I think it will rain today.'
    },
    { 
      id: 6, 
      word: 'Throw', 
      meaning: 'To send something through the air using your hand.',
      example: 'He threw the ball far.'
    },
    { 
      id: 7, 
      word: 'Try', 
    ...
    { 
      id: 8, 
      word: 'Turn', 
      meaning: 'To move something around a point.',
      example: 'Turn the page, please.'
    },
    { 
      id: 9, 
      word: 'Touch', 
      meaning: 'To feel something with your hand.',
