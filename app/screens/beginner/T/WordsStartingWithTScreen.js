...
// Words starting with T - defined outside component to prevent re-creation
const tWords = [
  {
    word: "Table",
    image: require("../../../../assets/items/table.png")
  },
  {
    word: "Tiger",
    image: require("../../../../assets/items/tiger.png")
  },
  {
    word: "Tree",
    image: require("../../../../assets/items/tree.png")
  },
  {
    word: "Train",
    image: require("../../../../assets/items/train.png")
  },
  {
    word: "Turtle",
    image: require("../../../../assets/items/turtle.png")
  }
];

export default function WordsStartingWithTScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenT1', {
            word: tWords[0].word.toUpperCase(),
            image: tWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
