...
export default function WordPuzzleScreenK1({ navigation, route }) {
  const { word = "KEY", image = require("../../../../assets/items/key.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHIJLMNOPQRSTUVWXZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenK2');
  };
