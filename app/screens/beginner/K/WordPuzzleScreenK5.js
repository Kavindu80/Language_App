...
export default function WordPuzzleScreenK5({ navigation, route }) {
  const { word = "KITCHEN", image = require("../../../../assets/items/kitchen.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABDFGJLMOPQRSUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenK');
  };
