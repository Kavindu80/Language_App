...
export default function WordPuzzleScreenK3({ navigation, route }) {
  const { word = "KING", image = require("../../../../assets/items/king.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFHJLMOPQRSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenK4');
  };
