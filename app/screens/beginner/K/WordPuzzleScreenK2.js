...
export default function WordPuzzleScreenK2({ navigation, route }) {
  const { word = "KITE", image = require("../../../../assets/items/kite.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHJLMNOPQRSUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenK3');
  };
