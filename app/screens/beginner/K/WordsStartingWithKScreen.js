...
// Words starting with K - defined outside component to prevent re-creation
const kWords = [
  {
    word: "Key",
  ...
  {
    word: "Kite",
    image: require("../../../../assets/items/kite.png")
  },
  {
    word: "King",
    image: require("../../../../assets/items/king.png")
  },
  {
    word: "Kangaroo",
    image: require("../../../../assets/items/kangaroo.png")
  },
  {
    word: "Kitchen",
    image: require("../../../../assets/items/kitchen.png")
  }
];

export default function WordsStartingWithKScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenK1', {
            word: kWords[0].word.toUpperCase(),
            image: kWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
