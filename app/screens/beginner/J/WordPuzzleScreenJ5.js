...
export default function WordPuzzleScreenJ5({ navigation, route }) {
  const { word = "JUAGUR", image = require("../../../../assets/items/jaguar.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEFGHIKLNOQRSTVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenJ');
  };
