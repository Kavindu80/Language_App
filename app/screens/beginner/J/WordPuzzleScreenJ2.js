...
export default function WordPuzzleScreenJ2({ navigation, route }) {
  const { word = "JAR", image = require("../../../../assets/items/jar.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDEFGHIKLMNOPQSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenJ3');
  };
