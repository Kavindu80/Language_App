...
export default function WordPuzzleScreenJ3({ navigation, route }) {
  const { word = "JELLY", image = require("../../../../assets/items/jelly.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHIKMNOPQRSTUVWXZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenJ4');
  };
