...
export default function WordPuzzleScreenJ4({ navigation, route }) {
  const { word = "JUICE", image = require("../../../../assets/items/juice.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABDFGHKLMNOPQRSTVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenJ5');
  };
