...
// Words starting with J - defined outside component to prevent re-creation
const jWords = [
  {
    word: "Jacket",
    image: require("../../../../assets/items/jacket.png")
  },
  {
    word: "Jar",
    image: require("../../../../assets/items/jar.png")
  },
  {
    word: "Jelly",
    image: require("../../../../assets/items/jelly.png")
  },
  {
    word: "Juice",
    image: require("../../../../assets/items/juice.png")
  },
  {
    word: "Jaguar",
    image: require("../../../../assets/items/jaguar.png")
  }
];

export default function WordsStartingWithJScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenJ1', {
            word: jWords[0].word.toUpperCase(),
            image: jWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
