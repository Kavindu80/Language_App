...
export default function WordPuzzleScreenC5({ navigation, route }) {
  const { word = "CUP", image = require("../../../../assets/items/cup.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABDEFGHIJKLMNQRSTVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenC');
  };
