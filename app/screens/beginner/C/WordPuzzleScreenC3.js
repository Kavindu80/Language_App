...
export default function WordPuzzleScreenC3({ navigation, route }) {
  const { word = "CAKE", image = require("../../../../assets/items/cake.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenC4');
  };
