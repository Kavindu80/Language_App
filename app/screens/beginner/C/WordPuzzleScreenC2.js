...
export default function WordPuzzleScreenC2({ navigation, route }) {
  const { word = "CAR", image = require("../../../../assets/items/car.png") } = route?.params || {};
  ...
  const savePuzzleStatus = async (status) => {
    try {
      ...
      // Update status for this puzzle (id 2)
      puzzleStatus[2] = status;
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenC3');
  };
