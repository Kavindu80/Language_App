...
export default function WordPuzzleScreenC1({ navigation, route }) {
  const { word = "CAT", image = require("../../../../assets/items/cat.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenC2');
  };
