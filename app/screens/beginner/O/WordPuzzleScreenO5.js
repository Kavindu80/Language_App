...
export default function WordPuzzleScreenO5({ navigation, route }) {
  const { word = "OIL", image = require("../../../../assets/items/oil.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHJKLMNPQRSTUVWXZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenO');
  };
