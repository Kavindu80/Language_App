...
// Words starting with O - defined outside component to prevent re-creation
const oWords = [
  {
    word: "Orange",
    image: require("../../../../assets/items/orange.png")
  },
  {
    word: "Owl",
    image: require("../../../../assets/items/owl.png")
  },
  {
    word: "Octopus",
    image: require("../../../../assets/items/octopus.png")
  },
  {
    word: "Onion",
    image: require("../../../../assets/items/onion.png")
  },
  {
    word: "Oil",
    image: require("../../../../assets/items/oil.png")
  }
];

export default function WordsStartingWithOScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenO1', {
            word: oWords[0].word.toUpperCase(),
            image: oWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
