...
export default function WordPuzzleScreenO2({ navigation, route }) {
  const { word = "OWL", image = require("../../../../assets/items/owl.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHIKLMNPQRSTUVXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenO3');
  };
