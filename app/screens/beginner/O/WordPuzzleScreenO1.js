...
export default function WordPuzzleScreenO1({ navigation, route }) {
  const { word = "ORANGE", image = require("../../../../assets/items/orange.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDFGHIKLMNPQSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenO2');
  };
