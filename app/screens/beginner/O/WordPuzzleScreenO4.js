...
export default function WordPuzzleScreenO4({ navigation, route }) {
  const { word = "ONION", image = require("../../../../assets/items/onion.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHJKLMPRQSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenO5');
  };
