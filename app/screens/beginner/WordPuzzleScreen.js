...
export default function WordPuzzleScreen({ navigation, route }) {
  const { word = "APPLE", image = require("../../../assets/items/apple.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreen2');
  };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.mainContent}>
          ...
          <View style={[styles.imageContainer, { width: imageSize, height: imageSize, borderRadius: imageSize / 2 }]}>
            <Image 
              source={typeof image === 'number' ? image : require("../../../assets/items/apple.png")} 
