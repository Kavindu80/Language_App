...
export default function WordPuzzleScreenI1({ navigation, route }) {
  const { word = "ICE", image = require("../../../../assets/items/ice.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABDFGHJKLMNOPQRSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenI2');
  };
