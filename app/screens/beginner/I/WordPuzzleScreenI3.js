...
export default function WordPuzzleScreenI3({ navigation, route }) {
  const { word = "INSECT", image = require("../../../../assets/items/insect.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABDFGHJKLMOPQRUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenI4');
  };
