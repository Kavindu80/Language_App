...
export default function WordPuzzleScreenI4({ navigation, route }) {
  const { word = "IRON", image = require("../../../../assets/items/iron.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEFGHJKLMPQSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenI5');
  };
