...
export default function WordPuzzleScreenI5({ navigation, route }) {
  const { word = "ISLAND", image = require("../../../../assets/items/island.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCEFGHJKMPQRTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('VerbsScreenI');
  };
