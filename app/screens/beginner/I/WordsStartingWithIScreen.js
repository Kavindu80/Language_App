...
// Words starting with I - defined outside component to prevent re-creation
const iWords = [
  {
    word: "Ice",
    image: require("../../../../assets/items/ice.png")
  },
  {
    word: "Igloo",
    image: require("../../../../assets/items/igloo.png")
  },
  {
    word: "Insect",
    image: require("../../../../assets/items/insect.png")
  },
  {
    word: "Iron",
  ...
  {
    word: "Island",
    image: require("../../../../assets/items/island.png")
  }
];

export default function WordsStartingWithIScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenI1', {
            word: iWords[0].word.toUpperCase(),
            image: iWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
