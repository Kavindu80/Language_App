...
export default function WordPuzzleScreen1({ navigation, route }) {
  const { word = "BALL", image = require("../../../../assets/items/ball.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenB2');
  };
