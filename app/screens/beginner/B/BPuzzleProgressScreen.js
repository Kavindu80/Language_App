...
export default function BPuzzleProgressScreen({ navigation }) {
  ...
  // B letter puzzles data
  const puzzles = [
    { id: 1, name: 'BALL', image: require('../../../../assets/items/ball.png') },
    { id: 2, name: 'BOOK', image: require('../../../../assets/items/book.png') },
    { id: 3, name: 'BANANA', image: require('../../../../assets/items/banana.png') },
    { id: 4, name: 'BEAR', image: require('../../../../assets/items/bear.png') },
    { id: 5, name: 'BIRD', image: require('../../../../assets/items/bird.png') },
  ];
  ...
  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('bPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>B Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenB${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
        ...
        <View style={styles.buttonContainer}>
          ...
          >
            <Text style={styles.continueButtonText}>Continue to Verbs</Text>
