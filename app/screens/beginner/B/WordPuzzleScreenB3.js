...
export default function WordPuzzleScreen3({ navigation, route }) {
  const { word = "BANANA", image = require("../../../../assets/items/banana.png") } = route?.params || {};
  ...
  const savePuzzleStatus = async (status) => {
    try {
      ...
      // Update status for this puzzle (id 3)
      puzzleStatus[3] = status;
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenB4');
  };
