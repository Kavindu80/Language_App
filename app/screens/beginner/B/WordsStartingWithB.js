...
// Words starting with B - defined outside component to prevent re-creation
const bWords = [
  {
    word: "Ball",
  ...
  {
    word: "Banana",
    image: require("../../../../assets/items/banana.png")
  },
  {
    word: "Bear",
    image: require("../../../../assets/items/bear.png")
  },
  {
    word: "Bird",
    image: require("../../../../assets/items/bird.png")
  },
  {
    word: "Book",
...
export default function WordsStartingWithBScreen_temp() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenB1', {
            word: bWords[0].word.toUpperCase(),
            image: bWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
