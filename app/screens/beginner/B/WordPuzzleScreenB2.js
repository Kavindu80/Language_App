...
export default function WordPuzzleScreen2({ navigation, route }) {
  const { word = "BOOK", image = require("../../../../assets/items/book.png") } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate('WordPuzzleScreenB3');
  };
