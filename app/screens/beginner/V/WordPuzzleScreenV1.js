...
export default function WordPuzzleScreenV1({ navigation, route }) {
  const { word = "VIOLIN", image = require("../../../../assets/items/violin.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEFGHIJKLMNOPQRSTUWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenV2');
  };
