...
// Words starting with V - defined outside component to prevent re-creation
const vWords = [
  {
    word: "Violin",
    image: require("../../../../assets/items/violin.png")
  },
  {
    word: "Volcano",
    image: require("../../../../assets/items/volcano.png")
  },
  {
    word: "Van",
    image: require("../../../../assets/items/van.png")
  },
  {
    word: "Vase",
    image: require("../../../../assets/items/vase.png")
  },
  {
    word: "Vegetable",
    image: require("../../../../assets/items/vegetable.png")
  }
];

export default function WordsStartingWithVScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenV1', {
            word: vWords[0].word.toUpperCase(),
            image: vWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
