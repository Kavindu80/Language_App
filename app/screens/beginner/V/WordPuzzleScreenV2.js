...
export default function WordPuzzleScreenV2({ navigation, route }) {
  const { word = "VOLCANO", image = require("../../../../assets/items/volcano.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDEFGHIJKLMNPQRSTUWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenV3');
  };
