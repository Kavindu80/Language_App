...
export default function WordPuzzleScreenV3({ navigation, route }) {
  const { word = "VAN", image = require("../../../../assets/items/van.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDEFGHIJKLMOPQRSTUWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenV4');
  };
