...
export default function WordPuzzleScreenV4({ navigation, route }) {
  const { word = "VASE", image = require("../../../../assets/items/vase.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDFGHIJKLMNOPQRTUWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenV5');
  };
