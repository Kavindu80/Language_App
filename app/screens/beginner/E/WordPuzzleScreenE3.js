...
export default function WordPuzzleScreenE3({ navigation, route }) {
  const { word = "EYE", image = require("../../../../assets/items/eye.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFGHIJKLMNOPQRSTUVWXZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate('WordPuzzleScreenE4');
  };
