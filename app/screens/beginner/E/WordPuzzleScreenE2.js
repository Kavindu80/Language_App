...
export default function WordPuzzleScreenE2({ navigation, route }) {
  const { word = "ELEPHANT", image = require("../../../../assets/items/elephant.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDFGIJKMQRSUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate('WordPuzzleScreenE3');
  };
