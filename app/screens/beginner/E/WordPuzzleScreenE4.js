...
export default function WordPuzzleScreenE4({ navigation, route }) {
  const { word = "EAR", image = require("../../../../assets/items/ear.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'BCDFGHIJKLMNOPQSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenE5');
  };
