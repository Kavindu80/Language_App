...
export default function WordPuzzleScreenE1({ navigation, route }) {
  const { word = "EGG", image = require("../../../../assets/items/egg.png") } = route?.params || {};
  ...
  const createPuzzleLetters = () => {
    ...
    const extraLetters = 'ABCDFHIJKLMNOPQRSTUVWXYZ'
      .split('')
  ...
  const moveToNextPuzzle = () => {
    ...
    navigation.navigate('WordPuzzleScreenE2');
  };
