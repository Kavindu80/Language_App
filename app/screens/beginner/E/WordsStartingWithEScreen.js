...
// Words starting with E - defined outside component to prevent re-creation
const eWords = [
  {
    word: "Egg",
    image: require("../../../../assets/items/egg.png")
  },
  {
    word: "Elephant",
  ...
  {
    word: "Eye",
    image: require("../../../../assets/items/eye.png")
  },
  {
    word: "Ear",
    image: require("../../../../assets/items/ear.png")
  },
  {
    word: "Earth",
    image: require("../../../../assets/items/earth.png")
  }
];

export default function WordsStartingWithEScreen() {
    ...
    >
      ...
      >
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('WordPuzzleScreenE1', {
            word: eWords[0].word.toUpperCase(),
            image: eWords[0].image,
          })}
          activeOpacity={0.7}
          disabled={isPlayingAudio}
        >
