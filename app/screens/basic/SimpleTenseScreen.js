  ...
  const tenseTypeOptions = [
    {
      ...
      description: "Things that happen now or every day."
    },
    {
    ...
    },
    {
      ...
      description: "Things that will happen later"
    }
  ];
    ...
    >
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Simple Tenses</Text>
          ...
          <View style={styles.characterSection}>
            ...
            >
              ...
              <Text style={styles.speechText}>
                {selectedTenseType ? `Great choice! 👍` : `Simple tenses show actions or events that happen in the past, present, or future. Pick a tense by tapping it! 👇`}
              </Text>
            </Animated.View>
          </View>
              ...
              >
                ...
                >
                  <View
                    style={[
                      styles.tenseCard,
                      selectedTenseType === tenseType.name && styles.selectedCard
                    ]}
                  >
                    ...
                    {selectedTenseType === tenseType.name && (
                      <View style={styles.checkmarkContainer}>
                        <Ionicons name="checkmark-circle" size={28} color="#0072ff" />
                      </View>
                    )}
                  </View>
                </TouchableOpacity>
          ...
          >
            ...
            >
              <View style={styles.continueButtonContent}>
                ...
                {selectedTenseType && <Ionicons name="arrow-forward" size={22} color="#0072ff" style={styles.continueIcon} />}
              </View>
            </TouchableOpacity>
          </Animated.View>
        </View>
