      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <Text style={styles.infoTitle}>
            {selectedPronoun ? `Selected: ${selectedPronoun}` : "Pronouns"}
          </Text>
          <Text style={styles.infoText}>
            {selectedPronoun 
              ? `"${selectedPronoun}" is a subject pronoun used at the beginning of a sentence. → ${selectedPronoun} is reading.` 
              : "Pronouns are words we use instead of names in a sentence."}
          </Text>
          </LinearGradient>
        </Animated.View>
        ...
        >
          ...
          <Text style={styles.infoText}>
            Subject pronouns come at the beginning of a sentence. They tell who is doing the action. Tap a pronoun to learn more.
          </Text>
          </LinearGradient>
        </Animated.View>
        ...
        <View style={styles.pronounsContainer}>
          ...
          {/* Pronouns Clouds arranged in a circle */}
